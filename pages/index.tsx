...
export default function Home() {
  return (
    <>
      ...
      <section className="cinema-enquiry" id="start">
        <div className="cinema-enquiry-heading">
          <p className="eyebrow">YOUR NEXT CHAPTER</p>
          <h2>Let’s make it yours.</h2>
          <p>
            Tell us what you have in mind. We’ll shape the next step together.
          </p>
        </div>

        <QuoteWizard attribution={{}} />
      </section>
